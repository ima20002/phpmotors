...
function buildVehiclesDisplay($vehicles)
{
   ...
   foreach ($vehicles as $vehicle) {
      $dv .= '<li>';
      $dv .= "<a href='/phpmotors/vehicles/?action=vehicleinfomation&invId=" . urlencode($vehicle['invId']) . "' title='View our $vehicle[invMake] lineup of vehicles'><img src='$vehicle[imgPath]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'></a>";
      $dv .= '<hr>';
...
function buildEachVehicleDisplay($vehicle)
{
   ...
   $dv .= '<li>';
   $dv .= "<div><img src='$vehicle[imgPath]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'></div>";
   $invPrice = $vehicle['invPrice'];
   $invPrice = number_format($invPrice, 0, '.', ',');
...
// Thumbnail Display
function buildThumnailDisplay($thumbnails){
   $dv = '<ul id="thumnails">';
   $dv .= '<li>';
